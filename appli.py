...
Label(framesaisie, text = nbrdetruc , bg="black", fg="green").pack()

Framebouton = Frame(letout, bg="green", borderwidth=2, relief=GROOVE)
Framebouton.pack(side=RIGHT, padx=10, pady=10)

Button(Framebouton, text ='Recherchez', command = lambda : recherchedescrap(valueurl), relief=SUNKEN, background ='black', fg="white").pack(side=TOP, padx=5, pady=5)
