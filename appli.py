...
#recuperation, de date et mise en formes pour traitement du nom du fichier
Label(framesaisie, text="filenames :", background ='black', fg="green").pack(side=LEFT)
ladate = avoirladate()
namefich = StringVar(framesaisie, value= ladate)
namefichier = Entry(framesaisie, textvariable = namefich , bg="black", fg="green").pack(side=LEFT)
